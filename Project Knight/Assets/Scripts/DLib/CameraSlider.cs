    ...
    void Update () {
        ...
        } else if (Input.touchCount == 2)
        {
            ...
            if(Input.GetTouch(0).phase == TouchPhase.Moved || Input.GetTouch(1).phase == TouchPhase.Moved)
            {
                ...
                if (camCamera.orthographicSize > mm_ZoomBounds.Max) { camCamera.orthographicSize = mm_ZoomBounds.Max; }
                else if(camCamera.orthographicSize < mm_ZoomBounds.Min) { camCamera.orthographicSize = mm_ZoomBounds.Min; }
            }
        }
    }
